...
Modules (default: all): ghostty shell git tmux nvim cli opencode vscode claude notes
...
ALL_MODULES=(ghostty shell git tmux nvim cli opencode vscode claude notes)
